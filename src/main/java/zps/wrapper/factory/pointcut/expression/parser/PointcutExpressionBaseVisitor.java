...
/**
 * This class provides an empty implementation of {@link PointcutExpressionVisitor},
 ...
 */
public class PointcutExpressionBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PointcutExpressionVisitor<T> {
    /**
     * {@inheritDoc}
     * <p>
     ...
     */
    @Override
    public T visitTargetType(PointcutExpressionParser.TargetTypeContext ctx) {
        return visitChildren(ctx);
    }
